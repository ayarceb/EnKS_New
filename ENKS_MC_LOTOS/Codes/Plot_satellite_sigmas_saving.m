...
random_n=[500,1000,1500];

cont=1;
for k=1:1   % Change from 1 to 3 to change the random sampling
for i=1:5
...
%     figure(i)
    ...
    randam_obs{k,i,:}=randi([1 n],1,random_n(k));  % almacenar las posiciones de las posiciones random para cada uno de los valores 
