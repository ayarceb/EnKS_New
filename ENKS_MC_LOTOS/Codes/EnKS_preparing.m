...
% This code saves the following matrixes for have for the analysis assimilation procedure 
...
% Esta segunda parte es el "Pain in the ass" ya que ll tercer dia de datos
...
%  B_state_lag3=Calculo_B_Cholesky(states_lag3,1);
 B_state_lag4=Calculo_B_Cholesky(states_lag4,1);
